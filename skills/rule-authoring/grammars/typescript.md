# typescript — tree-sitter named node types

> Generated from `vendor/grammars/tree-sitter-typescript/typescript/src/node-types.json` (183 named types).  
...
### string
  (children): [] escape_sequence | string_fragment
